...
- **It's a token-and-latency trade, and you should say so.** Roles + experts + debate + advocate + merge is on the order of *2N + 2* model calls for N experts. You're buying decision quality with compute and wall-clock. Know which you're optimizing.
